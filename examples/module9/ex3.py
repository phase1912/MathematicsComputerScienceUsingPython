...
# додаємо стрілки
plt.arrow(1, 0, 0.2, 0.2, length_includes_head=True,
          head_width=0.05, head_length=0.1)
plt.arrow(0.8, 2.1, -0.1, -0.2, length_includes_head=True,
          head_width=0.05, head_length=0.1)
plt.arrow(1.1, 2.2, 0.2, -0.1, length_includes_head=True,
          head_width=0.05, head_length=0.1)
plt.arrow(3.3, 1.1, -0.1, 0.2, length_includes_head=True,
          head_width=0.05, head_length=0.1)
